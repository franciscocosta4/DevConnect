                        ...
                        <div class="post-header">
                            <div class="post-author-container">
                                <div class="user-avatar"> <a
                                        href="{{ route('users.profile', $post->user->username) }}">{{ substr($post->user->name, 0, 1) }}</a>
                                </div>
                                <div class="author-info">
                                    <p class="post-author">
                                    <a
                                        href="{{ route('users.profile', $post->user->username) }}">{{ $post->user->name }}</a></p>
                            ...
                            @if (Auth::id() === $post->user_id)
                                <div class="action-group">
                                    <form action="{{ route('posts.destroy', $post->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button style="margin-top: 16px;" class="action-btn delete-btn" type="submit"
