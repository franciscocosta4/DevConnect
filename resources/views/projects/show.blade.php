    ...
    <div class="project-show-container">
        ...
        <div class="project-meta">
            <div class="meta-item">
                ...
                <span>Criado por: <a
                        href="{{ route('users.profile', $project->user->username) }}">{{ $project->user->name }}</a></span>
            </div>
            <div class="meta-item">
                <svg class="meta-icon" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div class="project-section">
                ...
                <div class="download-section">
                    @if(Storage::exists($project->zip_file_path))
                        <a href="{{ route('download.project', ['filename' => basename($project->zip_file_path)]) }}" class="download-btn">
